                    ...
                    <form action="<?php echo e(route('firebird.start')); ?>" method="POST" id="firebird-sync-form">
                        ...
                        <div class="fb-stepper mb-4" role="navigation" aria-label="Fases de sincronización">
                            ...
                            <div class="fb-step" data-step="alumnos">
                                ...
                                <span class="badge bg-secondary-subtle text-secondary ms-auto" data-mini="alumnos">0/<?php echo e(collect($catalogGroups['alumnos'])->flatten(1)->count()); ?></span>
                            </div>
                        </div>
                        ...
                        <fieldset class="fb-phase" data-phase="alumnos">
                            ...
                            <div class="fb-section-header" data-section="alumnos">
                                ...
                                <span class="fb-counter is-empty" data-counter="alumnos" aria-live="polite">0 / <?php echo e(collect($catalogGroups['alumnos'])->flatten(1)->count()); ?></span>
                            </div>
                            <div data-ciclo-banner hidden>
                            ...
                            <div id="group-alumnos" class="row g-2">
                                <?php $__currentLoopData = $catalogGroups['alumnos']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupName => $tables): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-12 col-md-6">
                                        <div class="fb-table-group">
                                            <div class="fb-tg-header">
                                                <span class="fw-semibold"><?php echo e($groupName); ?></span>
                                            ...
                                            <?php $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <label class="fb-sync-option">
                                                    <input class="form-check-input sync-table-checkbox" type="checkbox" name="tables[]" value="<?php echo e($table['fb']); ?>" data-mysql="<?php echo e($table['mysql']); ?>" data-requires-ciclo="true" data-requires-alumnos="true">
                                                    <div class="fb-option-info">
                                                        <div class="fb-option-name"><?php echo e($table['fb']); ?></div>
                                                        <div class="fb-option-desc">→ <?php echo e($table['mysql']); ?></div>
                                                    </div>
