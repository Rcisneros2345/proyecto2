<?php $__env->startSection('title', 'Agregar empleado'); ?>
<?php $__env->startSection('breadcrumb', 'Operación › Empleados › Agregar empleado'); ?>

<?php $__env->startSection('content'); ?>
<?php if (isset($component)) { $__componentOriginalf8d4ea307ab1e58d4e472a43c8548d8e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf8d4ea307ab1e58d4e472a43c8548d8e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Agregar empleado','subtitle' => 'Registra y enrola un empleado en un dispositivo biométrico.','hideTitle' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Agregar empleado','subtitle' => 'Registra y enrola un empleado en un dispositivo biométrico.','hide-title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
    ...
    <div class="card-body">
        <form action="<?php echo e(route('employees.store')); ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <select id="device_id" name="device_id" class="form-select <?php $__errorArgs = ['device_id'];
...
unset($__errorArgs, $__bag); ?>" required>
                    ...
                    <?php $__currentLoopData = $devices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $device): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($device->id); ?>"
                                <?php if(old('device_id') == $device->id || request('device_id') == $device->id): echo 'selected'; endif; ?>>
                            <?php echo e($device->name); ?> (<?php echo e($device->ip); ?>)
                        </option>
...
unset($__errorArgs, $__bag); ?>"
                              value="<?php echo e(old('password')); ?>" inputmode="numeric" placeholder="Opcional, ej. 1234">
...
unset($__errorArgs, $__bag); ?>"
                           value="<?php echo e(old('card_number')); ?>" inputmode="numeric"
...
unset($__errorArgs, $__bag); ?>">
                    <?php $__currentLoopData = \App\Models\Employee::roles(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($value); ?>" <?php if(old('role', 0) == $value): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <a href="<?php echo e(route('employees.index')); ?>" class="btn btn-link">Cancelar</a>
        </form>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\proyecto2\resources\views\employees\create.blade.php ENDPATH**/ ?>