...
<?php if($planesCount > 0): ?>
  <a href="<?php echo e(route('academia.planes.index')); ?>" class="card card-link h-100 p-3 text-decoration-none" style="border-left:3px solid var(--cat-lavender);"
     aria-label="Planes: <?php echo e($planesCount); ?> registros, Planes del ciclo">
    <div class="d-flex align-items-start gap-3">
      ...
      <div class="flex-grow-1 min-w-0">
        ...
        <div class="d-flex align-items-baseline gap-2">
          <span class="fw-bold" style="font-family:'JetBrains Mono',monospace;font-size:22px" data-mod-ciclo="Planes"><?php echo e($planesCount); ?></span>
          <?php if($planesCount !== null): ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\proyecto2\resources\views/academia/dashboard/_planes-module.blade.php ENDPATH**/ ?>