...
@if($materiasCount > 0)
  <a href="{{ route('academia.materias.index') }}" class="card card-link h-100 p-3 text-decoration-none" style="border-left:3px solid var(--cat-amber);"
     aria-label="Materias: {{ $materiasCount }} registros, Materias del ciclo">
    <div class="d-flex align-items-start gap-3">
      ...
      <div class="flex-grow-1 min-w-0">
        ...
        <div class="d-flex align-items-baseline gap-2">
          <span class="fw-bold" style="font-family:'JetBrains Mono',monospace;font-size:22px" data-mod-ciclo="Materias">{{ $materiasCount }}</span>
          @if($materiasCount !== null)
